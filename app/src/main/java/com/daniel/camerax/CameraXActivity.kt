...
import com.daniel.camerax.databinding.ActivityCameraxBinding
...
class CameraXActivity :AppCompatActivity(), SensorEventListener {
    ...
    private fun updateCameraUi() {
        binding.imageCaptureButton.setOnClickListener {
            requestPermissionStorage.launch(arrayOf(
                Manifest.permission.READ_EXTERNAL_STORAGE,
                Manifest.permission.WRITE_EXTERNAL_STORAGE
            ))
        }
            ...
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                    put(
                        ...
                        File(Environment.DIRECTORY_PICTURES, childTarget).path
                    )
                } else {
